...
var OrdersService = /** @class */ (function () {
    function OrdersService(orderRepo, productRepo, amqpConnection) {
    ...
    OrdersService.prototype.create = function (createOrderDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        productsIds = createOrderDto.items.map(function (item) { return item.product_id; });
                        uniqueProductIds = __spreadArrays(new Set(productsIds));
                        return [4 /*yield*/, this.productRepo.findBy({
                                id: typeorm_2.In(uniqueProductIds)
                            })];
                    case 1:
                        products = _a.sent();
                        if (products.length !== uniqueProductIds.length) {
                            throw new Error("Some product does not exist. Products " + productsIds + ", products find " + products.map(function (product) { return product.id; }));
                        }
                        order = order_entity_1.Order.create({
                            client_id: createOrderDto.client_id,
                            items: createOrderDto.items.map(function (items) {
                                var product = products.find(function (product) { return product.id === items.product_id; });
                                return {
                                    price: product.price,
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.amqpConnection.publish('amq.direct', 'OrderCreated', {
                                order_id: order.id,
